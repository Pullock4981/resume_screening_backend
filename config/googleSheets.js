...
function getGoogleSheetsClient() {
  ...
  if (!email || !privateKey) {
    throw new Error('Google Service Account Credentials (GOOGLE_SERVICE_ACCOUNT_EMAIL, GOOGLE_PRIVATE_KEY) are missing or incomplete. Place service_account.json in backend folder.');
  }
